...
const structure_db_select_format_service_1 = __importDefault(require("../service/structure-db-select-service/structure-db-select-format-service"));
...
const structureDbSelectFormatService = new structure_db_select_format_service_1.default(structureDbSelectService);
...
const pageInterfaceControllers = new page_interface_controllers_1.default(structureDbSelectFormatService, option_query_select_attributes_db_1.option_query_select_attributes_db);
