...
var StructureDbSelectServices = (function () {
    function StructureDbSelectServices(structureAdapterSelectFooter, structureAdapterSelectImages, structureAdapterSelectMenu) {
        var _this = this;
        ...
        this.searchAllContent = function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var _c, footer, images, menu, error_1;
            var attrFooter = _b.attrFooter, attrImages = _b.attrImages, attrMenu = _b.attrMenu;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _c = _d.sent(), footer = _c[0], images = _c[1], menu = _c[2];
                        return [2, {
                                footer: footer,
                                images: images,
                                menu: menu,
    ...
    return StructureDbSelectServices;
}());
