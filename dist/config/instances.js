...
const structure_select_formater_adapter_1 = __importDefault(require("../integrations/structure-adapter/structure-select-adapter/structure-select-formater-adapter"));
const response_error_1 = __importDefault(require("../middlewares/error/response-error"));
...
const structureSelectFormaterMenuDecorator = new structure_select_formater_adapter_1.default(structureSelectAdapterMenu);
const structureDbSelectService = new structure_db_select_service_1.default(structureSelectAdapterFooter, structureSelectAdapterImages, structureSelectFormaterMenuDecorator);
const verifyDatasObjectImages = new verify_datas_object_image_1.default();
const sructureAdapterCreateImage = new structure_adapter_create_image_1.default(verifyDatasObjectImages);
...
const generateHash = new generate_hash_1.default();
const encrypt = new encrypt_1.default();
const verifyDataUser = new verify_datas_user_1.default();
...
const responseError = new response_error_1.default();
exports.responseError = responseError;
const loginAdapter = new login_adapter_1.default();
const registerAdapter = new register_adapter_1.default();
